...
<html lang="en">
	...
	<body>
		<div class="menuBar">
            <div class="logoText">SUMMARY</div>
            <div class="signUp" onclick="window.location='/registration';">Sign Up</div>
            <div class="signIn" onclick="window.location='/login';">Sign In</div>
        </div>
